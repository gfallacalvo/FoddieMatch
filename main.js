...
// ------- Datos de demo ---------
const platosData = [
  {nombre:"Ajiaco Santafereño",descr:"Tradición en cada cucharada, perfecto para días fríos.",img:"img/ajiaco.jpg"},
  ...
  {nombre:"Arepa de Choclo",descr:"Dulzura y suavidad en cada bocado.",img:"img/arepa-choclo.jpg"}
];
const demoUsers = [
  {nombre:"Sofía",img:"img/user2.png",bio:"Fanática de la cocina fusión y el brunch dominguero."},
  {nombre:"Carlos",img:"img/user1.png",bio:"Amo los sabores tradicionales y los postres."},
  {nombre:"María",img:"img/user3.png",bio:"Vegana creativa. Siempre busco nuevos restaurantes."},
